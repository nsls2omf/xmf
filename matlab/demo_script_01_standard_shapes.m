% Demo script for standard 2D maps
...
fig_show_2d_maps(x1d, y1d, z2d_quad_sln, z2d_expression, 'Convex Ellipsoid');


%% 2.2. Concave Ellipsoid (CCVE)

[z2d_quad_sln, z2d_expression] = standard_concave_ellipsoid_height(x2d, y2d, abs_p, abs_q, theta);
fig_show_2d_maps(x1d, y1d, z2d_quad_sln, z2d_expression, 'Concave Ellipsoid');
...
fig_show_2d_maps(x1d, y1d, z2d_quad_sln, z2d_expression, 'Convex Elliptic Cylinder');

[z1d_quad_sln, z1d_expression] = standard_convex_elliptic_cylinder_height(x1d, abs_p, abs_q, theta);
fig_show_1d_height(x1d, z1d_quad_sln, z1d_expression, 'Convex Elliptic Cylinder');

sx1d = standard_convex_elliptic_cylinder_xslope(x1d, abs_p, abs_q, theta);
fig_show_1d_slope(x1d, sx1d, sx1d, 'Convex Elliptic Cylinder');
...
fig_show_2d_maps(x1d, y1d, z2d_quad_sln, z2d_expression, 'Convex Hyperbolic Cylinder');

[z1d_quad_sln, z1d_expression] = standard_convex_hyperbolic_cylinder_height(x1d, abs_p, abs_q, theta);
fig_show_1d_height(x1d, z1d_quad_sln, z1d_expression, 'Convex Hyperbolic Cylinder');

sx1d = standard_convex_hyperbolic_cylinder_xslope(x1d, abs_p, abs_q, theta);
fig_show_1d_slope(x1d, sx1d, sx1d, 'Convex Hyperbolic Cylinder');
...
fig_show_2d_maps(x1d, y1d, z2d_quad_sln, z2d_expression, 'Concave Hyperbolic Cylinder');

[z1d_quad_sln, z1d_expression] = standard_concave_hyperbolic_cylinder_height(x1d, abs_p, abs_q, theta);
fig_show_1d_height(x1d, z1d_quad_sln, z1d_expression, 'Concave Hyperbolic Cylinder');

sx1d = standard_concave_hyperbolic_cylinder_xslope(x1d, abs_p, abs_q, theta);
fig_show_1d_slope(x1d, sx1d, sx1d, 'Concave Hyperbolic Cylinder');
