...
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_convex_ellipsoid_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_concave_ellipsoid_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_convex_elliptic_cylinder_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
[z1d_res, z1d_fit, opt_params, opt_params_ci] = fit_convex_ellipse_height(x1d, z1d_measured, input_params, opt_structure);
...
[sx1d_res, sx1d_fit, opt_params, opt_params_ci] = fit_convex_ellipse_slope(x1d, sx1d_measured, input_params, opt_structure);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_concave_elliptic_cylinder_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
z1d_measured = z1d + randn(size(z1d))*height_measurement_noise_std;
[z1d_res, z1d_fit, opt_params, opt_params_ci] = fit_concave_ellipse_height(x1d, z1d_measured, input_params, opt_structure);
...
sx1d_measured = sx1d + randn(size(sx1d))*slope_measurement_noise_std;
[sx1d_res, sx1d_fit, opt_params, opt_params_ci] = fit_concave_ellipse_slope(x1d, sx1d_measured, input_params, opt_structure);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_convex_hyperboloid_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_concave_hyperboloid_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_convex_hyperbolic_cylinder_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
z1d_measured = z1d + randn(size(z1d))*height_measurement_noise_std;
[z1d_res, z1d_fit, opt_params, opt_params_ci] = fit_convex_hyperbola_height(x1d, z1d_measured, input_params, opt_structure);
...
sx1d_measured = sx1d + randn(size(sx1d))*slope_measurement_noise_std;
[sx1d_res, sx1d_fit, opt_params, opt_params_ci] = fit_convex_hyperbola_slope(x1d, sx1d_measured, input_params, opt_structure);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_concave_hyperbolic_cylinder_height(x2d, y2d, z2d_measured, input_params, opt_structure);
...
z1d_measured = z1d + randn(size(z1d))*height_measurement_noise_std;
[z1d_res, z1d_fit, opt_params, opt_params_ci] = fit_concave_hyperbola_height(x1d, z1d_measured, input_params, opt_structure);
fig_show_1d_fitting_height(x1d, z1d_measured, z1d_fit, z1d_res, true_params, opt_params, opt_params_ci, 'Convex Hyperbolic Cylinder');

sx1d = generate_1d_slope(@standard_concave_hyperbolic_cylinder_xslope, x1d, abs_p, abs_q, theta, x_i, beta);
sx1d_measured = sx1d + randn(size(sx1d))*slope_measurement_noise_std;
[sx1d_res, sx1d_fit, opt_params, opt_params_ci] = fit_concave_hyperbola_slope(x1d, sx1d_measured, input_params, opt_structure);
