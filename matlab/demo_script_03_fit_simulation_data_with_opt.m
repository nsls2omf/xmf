...
[z2d_res, z2d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_ellipsoid_height(x2d, y2d, z2d_measured, input_params_struct, opt_struct);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_elliptic_cylinder_height(x2d, y2d, z2d_measured, input_params_struct, opt_struct);
...
[z1d_res, z1d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_ellipse_height(x1d, z1d_measured, input_params_struct, opt_struct);
...
[sx1d_res, sx1d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_ellipse_slope(x1d, sx1d_measured, input_params_struct, opt_struct);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_hyperboloid_height(x2d, y2d, z2d_measured, input_params_struct, opt_struct);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_hyperbolic_cylinder_height(x2d, y2d, z2d_measured, input_params_struct, opt_struct);
...
z1d_measured = z1d + randn(size(z1d))*height_measurement_noise_std;
[z1d_res, z1d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_hyperbola_height(x1d, z1d_measured, input_params_struct, opt_struct);
...
sx1d_measured = sx1d + randn(size(sx1d))*slope_measurement_noise_std;
[sx1d_res, sx1d_fit, opt_params_struct, opt_params_ci_struct] = fit_convex_hyperbola_slope(x1d, sx1d_measured, input_params_struct, opt_struct);
...
z1d_measured = z1d + randn(size(z1d))*height_measurement_noise_std;
[z1d_res, z1d_fit, opt_params_struct, opt_params_ci_struct] = fit_concave_hyperbola_height(x1d, z1d_measured, input_params_struct, opt_struct);
fig_show_1d_fitting_height(x1d, z1d_measured, z1d_fit, z1d_res, true_params_struct, opt_params_struct, opt_params_ci_struct, 'Convex Hyperbolic Cylinder');

sx1d = generate_1d_slope(@standard_concave_hyperbolic_cylinder_xslope, x1d, abs_p, abs_q, theta, x_i, beta);
sx1d_measured = sx1d + randn(size(sx1d))*slope_measurement_noise_std;
[sx1d_res, sx1d_fit, opt_params_struct, opt_params_ci_struct] = fit_concave_hyperbola_slope(x1d, sx1d_measured, input_params_struct, opt_struct);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_sag_col_diaboloid_height(x2d, y2d, z2d_measured, input_scd_params_struct, opt_struct);
...
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res_wo_gamma, z2d_fit_wo_gamma, opt_params_wo_gamma, opt_params_ci_wo_gamma] = fit_tan_col_diaboloid_height(x2d, y2d, z2d_measured, input_tcd_params_struct, opt_struct);
...
z2d = generate_2d_curved_surface_height(@standard_tan_col_diaboloid_height, x2d, y2d, abs_p, abs_q_s, theta, x_i, y_i, z_i, alpha, beta, gamma);
z2d_measured = z2d + randn(size(z2d))*height_measurement_noise_std;
[z2d_res, z2d_fit, opt_params, opt_params_ci] = fit_tan_col_diaboloid_height(x2d, y2d, z2d_measured, input_tcd_params_struct, opt_struct);

fig_show_2d_different_fitting_maps(x1d, y1d, z2d_measured, z2d_fit_wo_gamma, z2d_res_wo_gamma, z2d_fit, z2d_res, true_tcd_params, opt_params_wo_gamma, opt_params_ci_wo_gamma, opt_params, opt_params_ci, 'Tangential Collimating Diaboloid');
