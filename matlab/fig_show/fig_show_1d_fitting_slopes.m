function fig_show_1d_fitting_slopes(x1d, sx1d_measured, sx1d_fit, sx1d_res, params_target, params_fit, params_ci, str_title)
...
plot(params_fit.x_i*1e3, interp1(x1d_mm, sx1d_fit_mrad, params_fit.x_i*1e3), 'ro', 'MarkerSize', marker_size, 'MarkerFaceColor', 'r'); 
set(gca, 'xTickLabel', []);
ylabel('x-slope [mrad]');
title(str_title);
