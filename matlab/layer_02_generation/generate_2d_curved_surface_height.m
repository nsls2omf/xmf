% Generate 2D curved surface height with rotation and translation
% function z2d = generate_2d_curved_surface_height(standard_height_function_handle, x2d, y2d, p, q, theta, x_i, y_i, z_i, alpha, beta, gamma, z2d_measured)
