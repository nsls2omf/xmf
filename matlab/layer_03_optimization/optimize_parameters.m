function [v_res, v_fit, opt_params_struct, opt_params_ci_struct, init_params] = optimize_parameters(surface_generation_function_handle, standard_surface_shape_function_handle, x, y, v, input_params_struct, opt_or_tol_struct)
...
%        opt_or_tol_struct is a structure of optimization flag or 
...
%        params_ci_struct is the confidence intervals of the pamrams.
...
if islogical(opt_or_tol_struct.p) % Use opt_struct
    ...
    [v_res, v_fit, opt_params_struct, opt_params_ci_struct, init_params] ...
