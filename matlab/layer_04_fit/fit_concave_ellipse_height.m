function [z1d_res, z1d_fit, opt_params_struct, opt_params_ci_struct, init_params_struct] = fit_concave_ellipse_height(x1d, z1d_measured, input_params_struct, opt_or_tol_struct)
