function [sx1d_res, sx1d_fit, params, params_ci] = fit_concave_ellipse_slope(x1d, sx1d_measured, params_input, is_opt_1d_cylinder_slope)
...
[sx1d_res, sx1d_fit, params, params_ci] = optimize_parameters ...
    ...
    , x1d, y1d, sx1d_measured, params_input, is_opt_1d_cylinder_slope);