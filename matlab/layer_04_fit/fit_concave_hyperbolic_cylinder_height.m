function [z2d_res, z2d_fit, opt_params_struct, opt_params_ci_struct, init_params_struct]=fit_concave_hyperbolic_cylinder_height(x2d, y2d, z2d, input_params_struct, opt_or_tol_struct)
...
%       - opt_params_struct - Fitted parameters of the concave hyperbolic cylinder
